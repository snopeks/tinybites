...
const EasyMeals = () => (
    <div className="content">
        ...
        <div className="text">
            ...
            <h2>Safety First</h2>
            <p>It's important to maintain proper safety precautions while feeding your baby.</p>
            <p>The two main hazards to be aware of are:</p>
            <ul>
                <li>Choking</li>
                <li>Allergies</li>
            </ul>
            ...
            <h2 className="centerHighlight">If you have any concerns about your baby's growth, health or nutrition, please discuss with your health care provider!</h2>
        </div>
